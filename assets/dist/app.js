...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"App\", function() { return App; });\n/* harmony import */ var _Home_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Home.js */ \"./components/Home.js\");\n/* harmony import */ var _Archive_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Archive.js */ \"./components/Archive.js\");\n/* harmony import */ var _Unsubscribe_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Unsubscribe.js */ \"./components/Unsubscribe.js\");\n\n\n\n\nvar App = {\n    components: {\n        'Home': _Home_js__WEBPACK_IMPORTED_MODULE_0__[\"Home\"],\n        'Archive': _Archive_js__WEBPACK_IMPORTED_MODULE_1__[\"Archive\"],\n        'Unsubscribe': _Unsubscribe_js__WEBPACK_IMPORTED_MODULE_2__[\"Unsubscribe\"]\n    },\n    data() {\n        return {\n        }\n    },\n    methods: {\n        test() {\n            console.log('ok');\n        }\n    },\n    computed: {\n        route() {\n            var path = window.location.pathname;\n            switch (path) {\n                case '/archive':\n                    return 'archive';\n                case '/unsubscribe':\n                    return 'unsubscribe';\n                default:\n                    return 'home';\n            }\n        },\n        loaded() {\n            return this.$root.loaded;\n        },\n    },\n    template: `\n        <div v-if=\"loaded\">\n            <Home v-if=\"route === 'home'\"/>\n            <Archive v-if=\"route === 'archive'\"/>\n            <Unsubscribe v-if=\"route === 'unsubscribe'\" />\n        </div>\n    `\n}\n\n//# sourceURL=webpack:///./components/App.js?");
